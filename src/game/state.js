...
export const shopItems = getMarketItems();
...
export function createInitialState() {
  return {
    ...
    stats: {
      ...
      biggestFishWaterId: null,
      biggestFishBait: null,
      biggestFishDepth: null,
      biggestFishCatchSpotId: null,
    },
    catchJournal: {},
    trophies: [],
    achievements: {

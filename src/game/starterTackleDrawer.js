...
export const drawerClutter = [
  { id: 'button', labelKey: 'drawerJunkButton', mark: 'o', x: 14, y: 22, drawer: 0 },
  { id: 'oldKey', labelKey: 'drawerJunkOldKey', mark: '?', x: 54, y: 18, drawer: 0 },
  { id: 'paper', labelKey: 'drawerJunkPaper', mark: '~', x: 78, y: 36, drawer: 0 },
  { id: 'oldHook', labelKey: 'drawerItemOldHook', mark: 'J', x: 36, y: 52, drawer: 0, useful: true },
  { id: 'box', labelKey: 'drawerJunkBox', mark: '#', x: 18, y: 72, drawer: 0 },
  { id: 'matches', labelKey: 'drawerJunkMatches', mark: '=', x: 66, y: 72, drawer: 0 },
  { id: 'embroideryThread', labelKey: 'drawerItemEmbroideryThread', mark: '@', x: 43, y: 28, drawer: 0, useful: true },
  { id: 'cap', labelKey: 'drawerJunkCap', mark: 'C', x: 21, y: 28, drawer: 1 },
  ...
  { id: 'stoneSinker', labelKey: 'drawerItemStoneSinker', mark: '*', x: 64, y: 62, drawer: 1, useful: true },
  { id: 'rag', labelKey: 'drawerJunkRag', mark: '~', x: 14, y: 66, drawer: 1 },
  { id: 'gooseFeatherFloat', labelKey: 'drawerItemGooseFeatherFloat', mark: '/', x: 42, y: 40, drawer: 1, useful: true },
